import type { Guess, FeedbackType } from '../../types'
        ...
        <tbody>
          {guesses.map((guess) => (
            <tr key={guess.driver.id}>
              ...
              <Cell value={guess.driver.wins} feedback={guess.feedback.wins} />
              <Cell value={guess.driver.debutYear} feedback={guess.feedback.debutYear} />
              <Cell
